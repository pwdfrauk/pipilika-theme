                    ...
                    <div class="lp-element lp-pom-text nlh" id="lp-pom-text-698" style="height: auto;">
                        <h2 style="line-height: 29px;">
                            <span
                                ...
                                <span style="font-size: 18px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                                    sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                                    veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                    consequat. Duis aute irure dolor in reprehenderit in voluptate velit.</span>
                            </span>
                        </h2>
                    </div>
                    <div style="margin-top:40px;">
                        <div class="lp-element lp-pom-text nlh" id="lp-pom-text-700"
                            ...
                            <p style="line-height: 29px;"><span
                                    style="color: rgb(17, 17, 17); font-size: 18px; font-family: Montserrat; font-weight: 400; font-style: normal;">Lorem
                ...
                <div class="col-md-6">
                    <div class="">
                        <div class="WhyChooseUs-bottom-img">
                            <img src="<?php echo get_template_directory_uri();?>/images/chice.png" alt="choice us image ">
                        </div>
                    </div>
                </div>
            </div>
