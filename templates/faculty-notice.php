                ...
                <div class="col-xs-12 col-md-7 facultyCard">
                    ...
                    <div class="facultyCardSingle col-xs-12">
                        <div class="facultyCardimg"
                            style="background: url('<?php echo get_template_directory_uri(); ?>/images/eee.jpg');background-repeat: no-repeat;background-size: cover;background-position: center;">
                        </div>
                    ...
                    <div class="facultyCardSingle col-xs-12">
                        <div class="facultyCardimg"
                            style="background: url('<?php echo get_template_directory_uri(); ?>/images/NoticeFacultyImg.jpg');background-repeat: no-repeat;background-size: cover;background-position: center;">
                        </div>
                        <div class="FacultyCardTitleAndDis">
                    ...
                    <div class="facultyCardSingle col-xs-12">
                        <div class="facultyCardimg"
                            style="background: url('<?php echo get_template_directory_uri(); ?>/images/me.jfif');background-repeat: no-repeat;background-size: cover;background-position: center;">
                        </div>
                        <div class="FacultyCardTitleAndDis">
                    ...
                    <div class="facultyCardSingle col-xs-12">
                        <div class="facultyCardimg"
                            style="background: url('<?php echo get_template_directory_uri(); ?>/images/ce.jpg');background-repeat: no-repeat;background-size: cover;background-position: center;">
                        </div>
                        <div class="FacultyCardTitleAndDis">
